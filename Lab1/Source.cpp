...
// Видалення відбувається шляхом записування на обраний запис пустої струкутури (все по нулях) та в занотовувані цієї позиції в booksGarbageFile.gb спеціальною структурою. При додаванні елементів відповідний метод шукатиме серед booksGarbageFile.gb інформацію де може записати новий запис
